...
namespace HospitalAppointmentSystem.Controllers
{
    public class CalismaGunsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CalismaGunId,DoktorId,Gun,BaslangicSaati,BitisSaati,SaatDilimleri")] CalismaGun calismaGun)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CalismaGunId,DoktorId,Gun,BaslangicSaati,BitisSaati,SaatDilimleri")] CalismaGun calismaGun)
        {
